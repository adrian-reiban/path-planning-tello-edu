...
class VoxelMap:
    def __init__(self, posicion=(0.0, 0.0, 0.0), escala=(1.0, 1.0, 1.0), textura=None, parent=None):
        ...
        # Cargando el modelo
        self.voxel = loader.loadModel("../Modelos/EGG/voxel_map")
        ...
        if textura is not None:
            ...
            textura = loader.loadTexture("../Modelos/Texturas/Entorno/uv_grass.png")
            self.voxel.setTexture(textura)

        # Agregando colisión al voxel
        nodo_colision = CollisionNode("voxel map")

...
from Algoritmos.Algoritmos2D_Animacion import a_star
...
fig.canvas.set_window_title("Algoritmo A*")
...
# Llamada y configuración inicial del algoritmo AStar
algoritmo_astar = a_star.AStar2D()
algoritmo_astar.configurar(entorno=base, start=start, meta=meta)
...
# Título del gráfico
# ax.set_title("Algoritmo A*", fontweight="bold", loc="center")
...
animacion = FuncAnimation(fig, update, frames=algoritmo_astar.ejecutar(), interval=10, blit=False, repeat=False)
plt.show()
